  ...
  <link rel="stylesheet" href="./resources/menu.css">
   ...
   <script type="text/javascript">
   	...
   	function changeView(value){
   		if(value==0){
   			location.href="project_create.do";	
   		}
   		else if(value=="1"){
   			location.href="project_create.do";
   		}
   		else if(value=="2"){
   			location.href="project_ing.do";
   		}
   		else if(value=="3"){
   			location.href="project_ed.do";
   		}
   	}
   </script>
<div id='menu'>
<ul>
   <li class='active has-sub'><a href='#'>Project</a>
      <ul>
        <li><a href="#" onclick="changeView(0)">Project 생성</a></li>
         <li><a href='project_ing.do' onclick="changeView(2)">진행중 Project</a></li>
