							...
							<div class="col-sm-8" class="panel panel-default">
								<div class="panel-body">
			                            ...
			                            <div class="col-lg-2">
											<select id="work" name="work" class="form-control">
												<c:forTokens var="item" items="업무,회의,외근,출장,교육,휴가,기타" delims=",">
					                           		<option value="${item}" <c:if test='${item==schInfo.work}'>selected</c:if>>${item}</option>
											 	</c:forTokens>
											</select>
			                            </div>
			                        </div>
									<div class="row form-group">
										...
										<div class="col-lg-2">
										<input class="form-control" size="16" id="ssenddate" name="ssenddate" readonly>
										</div>
										<div class="col-sm-2"></div>
									</div>
									<div class="row form-group">
			                        ...
			                        <div class="row form-group" style="float: right; margin-right: 138px">
			                            <a href="#" class="button" style="text-decoration:none">등록</a>
			                      		<a href="#" class="button" style="margin-left:10px; text-decoration:none">취소</a>
			                        </div>
								</div>
							</div>
							<div class="col-sm-2"></div>
